...
O [grafo de Petersen](http://pt.wikipedia.org/wiki/Grafo_de_Petersen)é um grafo com muitas  propriedades interessantes. O grafo de Petersen pode
...
serão conexos se `Intersection( ver[i], ver[j] ) = []`.
