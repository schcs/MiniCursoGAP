...
Para iniciar o sistema `GAP`, precisamos  abrir um terminal. Inicialmente, a sua tela aparece com na seguinte imagem (clique na imagem para aumentar).
...
2. salve o arquivo;
3. e reescreve `Read( "hello.g" );` no terminal.
...
Note que se escrever algo errado, o sistema vai entrar no `break loop`. Para sair do `break loop` escreva `quit;`.
