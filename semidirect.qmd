...
1. Agora, construa um homomorfismo $f$ de $h:=C_4$ para $n:=Aut(C_3) \cong C_2$. Verifique qual é imagem de $a^3$ por $f$, onde $\left<a\right>=C_4$. 
...
\begin{itemize}
    \item $C_4 \rtimes C_3$ e $C_{12}$ (com $H=C_4$ e $N=C_3$);
    \item $C_{12}$ (com $H=C_3 \times N=C_4$);
    \item $C_6 \times C_2$ e $D_{12}$ (com $H=C_2 \times C_2$ e $N=C_3$);
    \item $C_6 \times C_2$ e $A_4$ (com $H=C_3$ e $N=C_2 \times C_2$);
\end{itemize}
